...
#=================================================================
        ...
        if op.type == 25 or op.type == 26:
            ...
            #---------------------- Start Command ------------------------#
                        ...
                        if text.lower() == "menu":
                          if msg._from in admin:
                            md = "🎖「Selfbot |CITL|Family」🎖\n🎖Team Self Bot Protect🎖\n\n"
                            md += "┏━━━━━━━━━━━━\n┃🎖cek「@」\n"
                            md += "┃🎖gid\n"
                            md += "┃🎖yid\n"
                            md += "┃🎖me\n"
                          ...
                          if msg._from in admin:
                            ...
                            iconlink = "http://dl.profile.line-cdn.net/{}".format(str(citl.pictureStatus))
                            cl.sendMessageWithContent(msg.to,md,name,url,iconlink)
                        elif text.lower() == "steal":
                          if msg._from in admin:
                            md = " 🔏「Selfbot steal Command」🔏\n\n"
                            md += "┏━━━━━━━━━━━━\n┃🎖steal contact 「@」\n"
                            md += "┃🎖steal mid 「@」\n"
                            md += "┃🎖steal name 「@」\n"
                            md += "┃🎖steal bio 「@」\n"
                            ...
                            iconlink = "http://dl.profile.line-cdn.net/{}".format(str(citl.pictureStatus))
                            cl.sendMessageWithContent(msg.to,md,name,url,iconlink)
                        elif text.lower() == "grup":
                          if msg._from in admin:
                            md = " 🔏「Selfbot group Command」🔏\n\n"
                            md += "┏━━━━━━━━━━━━\n┃🎖gprotect\n"
                            md += "┃🎖list mention\n"
                            md += "┃🎖addmention 「text」\n"
                            md += "┃🎖buka qr\n"
                            ...
                            md += "┃🎖pp grup\n"
                            md += "┃🎖list member\n"
                            md += "┃🎖infogrup 「number grup」\n"
                            md += "┃🎖infomem 「number grup」\n"
                            md += "┃🎖leave: 「number grup」\n"
                            md += "┃🎖fbroadcast 「Text」\n"
                            md += "┃🎖gbroadcast 「Text」\n"
                            md += "┃🎖allbroadcast 「Text」\n"
                            md += "┃🎖gbroadcastimage: 「link image」\n"
                            md += "┃🎖fbroadcastimage: 「link image」\n"
                            md += "┃🎖bye\n"
                            md += "┃🎖respon\n"
                            md += "┃🎖kick「@」\n┗━━━━━━━━━━━━"
                            citl = cl.getContact(msg._from)
                            name = "[MENU UNTUK GRUP]"
                            url = "http://line.me/ti/p/bJ3NcNuJX3"
                            iconlink = "http://dl.profile.line-cdn.net/{}".format(str(citl.pictureStatus))
                            cl.sendMessageWithContent(msg.to,md,name,url,iconlink)
                        elif text.lower() == "setting":
                          if msg._from in admin:
                            md = " 🔏「Selfbot Set Command」🔏\n\n"
                            md += "┏━━━━━━━━━━━━\n┃🎖lihat pesan add\n"
                            md += "┃🎖lihat pesan respon\n"
                            md += "┃🎖lihat pesan welcome\n"
                            md += "┃🎖lihat pesan spam\n"
                            md += "┃🎖set pesan: 「Text」\n"
                            md += "┃🎖set respon: 「Text」\n"
                            md += "┃🎖set welcome: 「Text」\n"
                            md += "┃🎖set spam: 「Text」\n┗━━━━━━━━━━━━"
                            citl = cl.getContact(msg._from)
                            name = "[SETTING FOR YOU]"
                            url = "http://line.me/ti/p/bJ3NcNuJX3"
                            iconlink = "http://dl.profile.line-cdn.net/{}".format(str(citl.pictureStatus))
                            cl.sendMessageWithContent(msg.to,md,name,url,iconlink)
                        elif text.lower() == "hiburan":
                          if msg._from in admin:
                            md = " 🔏「Selfbot Fun Command」🔏\n\n"
                            md += "┏━━━━━━━━━━━━\n┃🎖cuaca 「Location」\n"
                            md += "┃🎖sholat: 「Location」\n"
                            md += "┃🎖lokasi: 「Location」\n"
                            md += "┃🎖artinama: 「Nama」\n"
                            ...
                            md += "┃🎖spamcall\n┗━━━━━━━━━━━━"
                            citl = cl.getContact(msg._from)
                            name = "[SEMOGA TERHIBUR]"
                            url = "http://line.me/ti/p/bJ3NcNuJX3"
                            iconlink = "http://dl.profile.line-cdn.net/{}".format(str(citl.pictureStatus))
                            cl.sendMessageWithContent(msg.to,md,name,url,iconlink)
                        elif text.lower() == "owner":
                          if msg._from in admin:
                            md = " 🔏「Selfbot Creator/Admin Command」🔏\n\n"
                            md += "┏━━━━━━━━━━━━\n┃🎖add admin: 「on/off」\n"
                            md += "┃🎖del admin\n"
                            md += "┃🎖add admin: 「on/off」\n"
                            md += "┃🎖kontak admin\n"
                            ...
                            md += "┃🎖list bots\n┗━━━━━━━━━━━━"
                            citl = cl.getContact(msg._from)
                            name = "[MENU ADMIN/OWNER]"
                            url = "http://line.me/ti/p/bJ3NcNuJX3"
                            iconlink = "http://dl.profile.line-cdn.net/{}".format(str(citl.pictureStatus))
                            cl.sendMessageWithContent(msg.to,md,name,url,iconlink)
                        elif text.lower() == "bl":
                          if msg._from in admin:
                            md = " 🔏「Selfbot blacklist Command」🔏\n\n"
                            md += "┏━━━━━━━━━━━━\n┃🎖blc\n"
                            md += "┃🎖ban:on\n"
                            md += "┃🎖unban:on\n"
                            md += "┃🎖talkban:on\n"
                          ...
                          if msg._from in admin:
                            md = " 🔏「Selfbot Protect Command」🔏\n\n"
                            md += "┏━━━━━━━━━━━━\n┃🎖protect 「on/off」\n"
                            md += "┃🎖protectqr 「on/off」\n"
                            md += "┃🎖protectjoin 「on/off」\n"
                            md += "┃🎖protectinvite 「on/off」\n"
                            md += "┃🎖qrlock 「on/off」\n"
                            md += "┃🎖namelock 「on/off」\n"
                            md += "┃🎖filter chat 「on/off」\n┗━━━━━━━━━━━━"
                            citl = cl.getContact(msg._from)
                            name = "[MENU PROTECT]"
                            url = "http://line.me/ti/p/bJ3NcNuJX3"
                            iconlink = "http://dl.profile.line-cdn.net/{}".format(str(citl.pictureStatus))
                          ...
                          if msg._from in admin:
                            ...
                            if msg._from in admin:
                                ...
                                md = "🎖「Setting Selfbot CITL」🎖\n🔏Di group : 「" + str(ginfo.name)+"」\n\n"
                                if Setmain["CITLautoscan"] == True: md+="┏━━━━━━━━━━━━\n┃🎖 Cekmid「✅」\n"
                                else: md+="┏━━━━━━━━━━━━\n┃🎖 Cekmid「✖」\n"
                                if Setmain["contact"] == True: md+="┃🎖 Cekcontact「✅」\n"
                                else: md+="┃🎖 Cekcontact「✖」\n"
                                if Setmain["cekUnsend"] == True: md+="┃🎖 Cekunsend「✅」\n"
                                else: md+="┃🎖 Cekunsend「✖」\n"
                                if Setmain["checkPost"] == True: md+="┃🎖 Cekpost「✅」\n"
                                else: md+="┃🎖 Cekpost「✖」\n"
                                if Setmain["sticker"] == True: md+="┃🎖 Ceksticker「✅」\n"
                                else: md+="┃🎖 Ceksticker「✖」\n"
                                if Setmain["CITLautoread"] == True: md+="┃🎖 Autoread「✅」\n"
                                else: md+="┃🎖 Autoread「✖」\n"
                                if Setmain["CITLautojoin"] == True: md+="┃🎖 Autojoin「✅」\n"
                                else: md+="┃🎖 Autojoin「✖」\n"
                                if Setmain["CITLautoadd"] == True: md+="┃🎖 Autoadd「✅」\n"
                                else: md+="┃🎖 Autoadd「✖」\n"
                                if Setmain["autoReject"] == True: md+="┃🎖 Autoreject「✅」\n"
                                else: md+="┃🎖 Autoreject「✖」\n"
                                if Setmain["detectMention"] == True: md+="┃🎖 Autorespon「✅」\n"
                                else: md+="┃🎖 Autorespon「✖」\n"
                                if msg.to in welcome: md+="┃🎖 Autowelcome「✅」\n"
                                else: md+="┃🎖 Autowelcome「✖」\n"
                                ...
                                if Setmain["kick"] == True: md+="┃🎖 Filter chat「✅」\n┗━━━━━━━━━━━━"
                                else: md+="┃🎖 Filter chat「✖」\n┗━━━━━━━━━━━━"
            ...
            #---------------------- On/Off Command -------------------# 
                          ...
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                              if Setmain["Mentionkick"] == False:
                                ...
                                cl.sendMessageWithMention(msg.to,msg._from,"","Mention kick Set to on")
                          ...
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                              if Setmain["Mentionkick"] == True:
                                ...
                                cl.sendMessageWithMention(msg.to,msg._from,"","Mention kick set to off")

                        elif text.lower() == 'cekcontact on':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["contact"] = True
                                cl.sendMessageWithMention(msg.to,msg._from,"","Contact on")

                        elif text.lower() == 'cekcontact off':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["contact"] = False
                                cl.sendMessageWithMention(msg.to,msg._from,"","Contact off")

                        elif text.lower() == 'autorespon on':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["detectMention"] = True
                                cl.sendMessageWithMention(msg.to,msg._from,"","Auto Respon Set to on")

                        elif text.lower() == 'autorespon off':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["detectMention"] = False
                                cl.sendMessageWithMention(msg.to,msg._from,"","Auto respon Set to off")
                        elif text.lower() == 'ceksticker on':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["sticker"] = True
                                cl.sendMessageWithMention(msg.to,msg._from,"","Cek Sticker set to on")

                        elif text.lower() == 'ceksticker off':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["sticker"] = False
                                cl.sendMessageWithMention(msg.to,msg._from,"","Cek Sticker Set to off")
                        elif text.lower() == 'cekunsend on':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["cekUnsend"] = True
                                cl.sendMessageWithMention(msg.to,msg._from,"","Cek unsend pesan on")

                        elif text.lower() == 'cekunsend off':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["cekUnsend"] = False
                                cl.sendMessageWithMention(msg.to,msg._from,"","Cek unsend Pesan off")
                        elif text.lower() == 'cekpost on':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["checkPost"] = True
                                cl.sendMessageWithMention(msg.to,msg._from,"","Cekpost on")

                        elif text.lower() == 'cekpost off':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["checkPost"] = False
                                cl.sendMessageWithMention(msg.to,msg._from,"","Cekpost off")
                        elif text.lower() == "autoreject on":
                            if msg._from in admin:
                                if Setmain["autoReject"] == False:
                                    Setmain["autoReject"] = True
                                    cl.sendMessageWithMention(msg.to,msg._from,"","autoReject diaktifkan")
                                else:
                            ...
                            if msg._from in admin:
                                if Setmain["autoReject"] == True:
                                    ...
                                    cl.sendMessageWithMention(msg.to,msg._from,"","autoReject dinonaktifkan")
                                else:
                            ...
                            if msg._from in admin:
                                if Setmain["CITLautojoin"] == False:
                                    ...
                                    cl.sendMessageWithMention(msg.to,msg._from,"","Auto diaktifkan")
                                else:
                                    cl.sendMessageWithMention(msg.to,msg._from,"","Sudah aktif")
                            ...
                            if msg._from in admin:
                                if Setmain["CITLautojoin"] == True:
                                    ...
                                    cl.sendMessageWithMention(msg.to,msg._from,"","Autojoin dinonaktifkan")
                                else:
                                    cl.sendMessageWithMention(msg.to,msg._from,"","Sudah off")    
                            ...
                            if msg._from in admin:
                                if Setmain["CITLautoadd"] == True:
                                    ...
                                    cl.sendMessageWithMention(msg.to,msg._from,"","Sudah off")                             
                        elif text.lower() == 'filter chat on':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["kick"] = True
                                cl.sendMessageWithMention(msg.to,msg._from,"","filter pesan telah aktif\nDilarang mengunakan kata kotor atau kata larangan lain nya")

                        elif text.lower() == 'filter chat off':
                          if Setmain["selfbot"] == True:
                            if msg._from in admin:
                                Setmain["kick"] = False
                                cl.sendMessageWithMention(msg.to,msg._from,"","filder pesan di matikan")
                          ...
                          if msg._from in admin:
                            cl.sendMessageWithMention(msg.to, msg._from, "","ini kontakmu")
                          ...
                          if msg._from in admin :
                            ...
                            cl.sendMessageWithMention(msg.to, msg._from, "","ini nickname mu\n" + me.displayName)
                        elif text.lower() == 'mybio':
                          if msg._from in admin:
                            me = cl.getContact(msg._from)
                            cl.sendMessageWithMention(msg.to, msg._from, "","ini bioku\n" + me.statusMessage)
                        elif text.lower() == 'mypicture':
                          if msg._from in admin:
                            me = cl.getContact(msg._from)
                            cl.sendMessageWithMention(msg.to, msg._from, "Ini pp kak "," yg paling keceh")
                          ...
                          if msg._from in admin :
                            Setmain["pesan"] = msg.text.replace("Set pesan:","")
                            cl.sendText(msg.to,"We changed the message")
                        elif "Set welcome: " in msg.text:
                          if msg._from in admin:
                            Setmain["welcome"] = msg.text.replace("Set welcome: ","")
                            cl.sendText(msg.to,"update welcome message succes"+ datetime.today().strftime('%H:%M:%S'))

                        elif 'Set respon: ' in msg.text:
                           if msg._from in admin:
                              c = msg.text.replace('Set respon: ','')
                              if c in [""," ","\n",None]:
                          ...
                          if msg._from in admin:
                             Setmain["CITLspam"] = msg.text.replace('Set spam: ','')
                             cl.sendMessage(msg.to, "「Spam」\nSpam diganti jadi :\n\n「"+ Setmain["CITLspam"] +"」")
                        elif text.lower() == "lihat pesan add":
                          if msg._from in admin:
                             cl.sendMessage(msg.to, "「Pesan」\n\n" + Setmain["pesan"])

                        elif text.lower() == "lihat pesan welcome":
                          if msg._from in admin:
                             cl.sendMessage(msg.to, "「Welcome」\n\n" + Setmain["welcome"])

                        elif text.lower() == "lihat pesan respon":
                          if msg._from in admin:
                             cl.sendMessage(msg.to, "「Respon」\n\n" + Setmain["Respontag"])

                        elif text.lower() == "lihat pesam spam":
                          if msg._from in admin:
                             cl.sendMessage(msg.to, "「Spam」\n\n" + Setmain["CITLspam"])
...
#================[script steal]==================
                        ...
                        elif msg.text.lower().startswith("steal pp "):
                          if msg._from in admin:
                            if 'MENTION' in msg.contentMetadata.keys()!= None:
                                names = re.findall(r'@(\w+)', text)
                                mention = eval(msg.contentMetadata['MENTION'])
                        ...
                        elif msg.text.lower().startswith("steal pp video "):
                          if msg._from in admin:
                            if 'MENTION' in msg.contentMetadata.keys()!= None:
                                names = re.findall(r'@(\w+)', text)
                                mention = eval(msg.contentMetadata['MENTION'])
 ...
 #================[script steal Done]==================                                       
                        ...
                        elif msg.text.lower().startswith('addtikel'):
                          if msg._from in admin :
                            separate = text.split(" ")
                          ...
                          if msg._from in admin:
                            try:
                                arr = []
                                creator = "uec13f3c18fd696fe7c2ffd4c7e001a31"
                                ...
                                ret_ += "\n⏳ 「Aktif Selama」 : "+waktu(eltime)
                                ret_ += "\n🔝 「Version」 : v2,0"
                                ret_ += "\n🏅 「Creator」 : {}".format(creator.displayName)
                                ret_ += "\n\n「Thank's To CITL DESIGN」\nSuported By 「🔰ᴿᴬFᴀᴍɪʟʏ™」"
                          ...
                          if Setmain["selfbot"] == True:
                            ...
                            if msg._from in admin:
                              if Setmain["CITLblacklist"] == {}:
                                ...
                                cl.sendMessage(msg.to,"🔏━━━「BlacklistUsed」━━━🔏\n\n"+ma+"\n🔏「%s」Blacklist User🔏" %(str(len(Setmain["CITLblacklist"]))))
                            ...
                            if msg._from in admin:
                              if Setmain["Talkblacklist"] == {}:
                                ...
                                for m_id in Setmain["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"??━━━「ListTalkBan」━━━🔏\n\n"+ma+"\n🔏「%s」Talkban User🔏" %(str(len(Setmain["Talkblacklist"]))))
                        ...
                        elif msg.text.lower() == "list mention":
                          if msg._from in admin :
                            if Setmain["mention"] == {}:
                        ...
                        elif msg.text.lower().startswith('addmention'):
                          if msg._from in admin :
                            separate = text.split(" ")
                            text = text.replace(separate[0]+" ","")
...
#===========Hiburan============#
                        ...
                        elif text.lower().startswith("mimpi: "):
                          if msg._from in admin:
                            sep = msg.text.split(" ")
...
#===================================================
                        ...
                        elif text.lower().startswith("aplikasi: "):
                          if msg._from in admin:
                            sep = msg.text.split(" ")
                      ...
                      #      sep = text.split(" ")
                        ...
                        elif "Fbroadcast " in msg.text:
                          if msg._from in admin:
                         
                            txt =  msg.text.replace("Fbroadcast ","")
                        ...
                        elif text.lower() == 'pp grup':
                          if msg._from in admin:
                            group = cl.getGroup(msg.to)
                            path = "http://dl.profile.line-cdn.net/" + group.pictureStatus
                            cl.sendImageWithURL(msg.to, path)
                        elif text.lower() == 'nama grup':
                            gid = cl.getGroup(msg.to)
                            cl.sendMessage(msg.to, "「Nama Group」 : \n" + gid.name)
                        elif text.lower() == 'qr grup':
                          if msg._from in admin:
                            if msg.toType == 2:
                                group = cl.getGroup(msg.to)
                                if group.preventedJoinByTicket == False:
